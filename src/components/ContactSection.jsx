  ...
  try {
    const response = await fetch("https://formspree.io/f/mkgvlzey", {
      ...
      headers: {
        ...
        Accept: "application/json", // Formspree cần thêm header này
      },
    ...
    <section id="contact" className="py-24 px-4 relative bg-secondary/30">
      <div className="container mx-auto max-w-5xl">
        ...
        <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto">
          I&apos;m still early in my journey as a software engineer, but
          I&apos;m eager to learn, explore, and take on new challenges. If you
